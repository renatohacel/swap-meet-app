...
export const printPadronTianguisService = async (id) => {
    const response = await axiosInstance.get(`/reportes/print/reportes-padron-tianguis/${id}`, {
        responseType: "blob",
    });
    ...
    if (contentType && contentType.includes("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet")) {
        ...
        link.href = url;
        link.download = `reporte-padron-tianguis-${fechaActual}.xlsx`;
